...
# Outline should only apply to main_menu
# define gui.interface_text_outlines = [(2, "#FFF6EA", 0, 0)]
...
screen game_menu(title, scroll=None, yinitial=0.0, spacing=0):
    ...
    frame:
        ...
        hbox:
            ...
            frame:
                ...
                # this moves the entire game_menu content frame upwards lol.
                ypos -85
                if scroll == "viewport":
    ...
    textbutton _("Return"):
        style "return_button"
        # Moved the return button up a little bit. And also a bit to the side.
        ypos 960
        xpos 45
        action Return()
    ...
    use game_menu(_("Config"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    # lowered the vbox containing text speed and auto forward to stop it from hiding the design
                    ypos 50
                    xpos 175
                    label _("Text Speed")
